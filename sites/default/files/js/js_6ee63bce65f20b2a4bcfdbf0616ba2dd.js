...
/* -------------------translate orange box-------------------*/
	  $("body.i18n-en #rightnodecontent a").html('Visit the<br />website'); 	  
	  
	  
	  
	 <!-- webform trick  -->    
		$("form#webform-client-form-17").after($('#framemap'));  
		
		   
	  $("form#webform-client-form-17 .description").html('Προσθέστε τα 2 νούμερα και πληκτρολογείστε το αποτέλεσμα. π.χ. για 1+3, συμπληρώστε 4.'); 
	  
	  <!-- webform --> 
	  
	 /* name*/
	  $('#edit-submitted-testfieldset-name').attr('value', 'Ονομα');
	   
	  $('#edit-submitted-testfieldset-name').focus(function(){
		if ($(this).val()=='Ονομα') $(this).val('');
	}).blur(function(){
		if ($(this).val()=='' || $(this).val()=='Ονομα') $(this).val('Ονομα').addClass('invalid');
	...
	/* email */
	$('#edit-submitted-fieldset-emailphone-e-mail').attr('value', 'E-mail');
	   
	  $('#edit-submitted-fieldset-emailphone-e-mail').focus(function(){
		if ($(this).val()=='E-mail') $(this).val('');
	}).blur(function(){
		if ($(this).val()=='' || $(this).val()=='E-mail') $(this).val('E-mail').addClass('invalid');
		else $(this).removeClass('invalid');
	});
	...
	/* phone */
	$('#edit-submitted-fieldset-emailphone-phone').attr('value', 'Τηλεφωνο');
	
		  $('#edit-submitted-fieldset-emailphone-phone').focus(function(){
		if ($(this).val()=='Τηλεφωνο') $(this).val('');
	}).blur(function(){
		if ($(this).val()=='' || $(this).val()=='Τηλεφωνο') $(this).val('Τηλεφωνο').addClass('invalid');
		else $(this).removeClass('invalid');
	});
		...
		/* message */
	$('#edit-submitted--message').attr('value', 'Το μηνυμα σας');
	
		  $('#edit-submitted--message').focus(function(){
		if ($(this).val()=='Το μηνυμα σας') $(this).val('');
	}).blur(function(){
		if ($(this).val()=='' || $(this).val()=='Το μηνυμα σας') $(this).val('Το μηνυμα σας').addClass('invalid');
		else $(this).removeClass('invalid');
	});
	
	
		/* taxonomy page */
		$("body.page-website-portfolio .views-row:nth-child(4n), .view-display-id-page .views-row:nth-child(4n)").addClass("nomargin");


		/* trick for chat menu item */
		$('li#menu-759 a, a.chatlink').click(function(){
		window.open('http://websynergy.gr/websynergy/live-support/livezilla.php?en=U3B5cm9z&amp;ee=aW5mb0B3ZWJzeW5lcmd5Lmdy&amp;reset=true','','width=600,height=600,left=0,top=0,resizable=yes,menubar=no,location=yes,status=yes,scrollbars=yes');
		return false;
		}); 
